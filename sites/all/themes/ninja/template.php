 ...
 */
function ninja_preprocess_html(&$variables) {
  ...
  $variables['classes_array'][] = 'ninja';
}

/**
 * Implements hook_preprocess_page().
 */
function ninja_preprocess_page(&$variables) {
  ...
  $path_to_format = drupal_get_path('theme', 'ninja
') . $options[$my_format];
 ...
 */
function ninja_preprocess_comment(&$variables) {
 ...
 * Reformat date info. See http://wiki.whatwg.org/wiki/Time_element.
 */
function ninja_preprocess_node(&$variables) {
  // Use Drupal's format_date function to reformat dates for the <time> element.
